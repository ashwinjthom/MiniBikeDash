...
The optocoupler is wired for negative logic such that TIM3 samples at 100KHz and captures the falling edge. The time between captures is processesed and converted into RPM.
